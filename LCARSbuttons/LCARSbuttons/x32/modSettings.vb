    ...
    Public NotInheritable Class modSettings
        ...
        Public Shared Sub InitializeSettings(Optional ByVal mode As SettingInitializationOptions = SettingInitializationOptions.All)
            ...
            If mode = SettingInitializationOptions.All Then
                ...
                SaveSetting("LCARS X32", "Application", "ClockMode", GetSetting("LCARS X32", "Application", "ClockMode", "TNG"))
                SaveSetting("LCARS X32", "Application", "ModernStardateStyle", GetSetting("LCARS X32", "Application", "ModernStardateStyle", "Fractional"))
            ...
            If mode = SettingInitializationOptions.RestoreToDefaults Then
                ...
                SaveSetting("LCARS X32", "Application", "ClockMode", "TNG")
                SaveSetting("LCARS X32", "Application", "ModernStardateStyle", "Fractional")
